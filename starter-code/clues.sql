...
SELECT name, continent, region, population, country code FROM country WHERE region = 'Southern Europe' ORDER BY population ASC;
...
SELECT name, population, countrycode FROM city WHERE population='91084';
     name     | population 
--------------+------------
 Santa Monica |      91084


-- She's in ____Santa Monica, USA___________!
